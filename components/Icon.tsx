...
const Icon: React.FC<IconProps> = ({ name, className = '', ...rest }) => {
  ...
  const icons: Record<string, JSX.Element> = {
    ...
    shield: <path d="M12 2l7 3v5c0 5-3.5 9.7-7 11-3.5-1.3-7-6-7-11V5l7-3z" />,
    trash_can: <><path d="M3 6h18" /><path d="M8 6v12a2 2 0 0 0 2 2h4a2 2 0 0 0 2-2V6" /><path d="M10 2h4" /></>,
    prayer_rug: <path d="M3 7c0-1 1-3 9-3s9 2 9 3v10c0 1-1 3-9 3S3 18 3 17V7z M6 9h12M6 12h12M6 15h12" />, 
    tasbih: <><circle cx="4" cy="12" r="1.6" /><circle cx="8" cy="10" r="1.6" /><circle cx="12" cy="9" r="1.6" /><circle cx="16" cy="10" r="1.6" /><circle cx="20" cy="12" r="1.6" /><path d="M5 12c2-1 4-2 7-3 3 1 5 2 7 3" /></>,
